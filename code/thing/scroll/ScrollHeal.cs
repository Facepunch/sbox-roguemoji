...
public partial class ScrollHeal : Scroll
{
    ...
    public override void Use(Thing user, GridType gridType, IntVector targetGridPos)
    {
        ...
        targetThing.AddFloater($"{Globals.Icon(IconType.Heal)}", 0.5f, new Vector2(0, 3f), new Vector2(0, -4f), height: 0f, text: "", requireSight: true, alwaysShowWhenAdjacent: true, EasingType.SineOut, fadeInTime: 0.1f, opacity: 0.5f);
