...
public partial class PotionEnergy : Thing
{
    ...
    public PotionEnergy()
	{
        ...
        SetTattoo("🔋", scale: 0.5f, offset: new Vector2(-0.525f, 4f), offsetWielded: new Vector2(-3f, 2f), offsetInfo: new Vector2(-8.75f, 11.5f), offsetCharWielded: new Vector2(-0.9f, 5.5f), offsetInfoWielded: new Vector2(-6.8f, 6f));
        ...
        if (Game.IsServer)
        {
            ...
            AddTrait("", "🔋", $"Drinking recovers {EnergyAmount}🔋", offset: new Vector2(0f, -2f), labelText: $"+{EnergyAmount}", labelFontSize: 15, labelOffset: new Vector2(0f, 0f), labelColor: new Color(1f, 1f, 1f));
        }
    }
