...
public partial class WhiteCane : Thing
{
	...
	public WhiteCane()
	{
        ...
        if (Game.IsServer)
        {
            ...
            AddTrait("", "😎", "Prevents your 👁️ from reaching zero.", offset: Vector2.Zero, tattooIcon: "🦯", tattooScale: 0.7f, tattooOffset: new Vector2(7f, 6f));
        }
    }
    ...
    public override void OnWieldedBy(Thing thing)
    {
        ...
        Trait = thing.AddTrait("", "😎", "Your 👁️ can't go down to zero.", offset: Vector2.Zero, tattooIcon: "🦯", tattooScale: 0.7f, tattooOffset: new Vector2(7f, 6f), source: DisplayName);
    }
