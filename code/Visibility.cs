...
public class Visibility
{
    ...
    /// </param>
    public Visibility(Func<int, int, bool> blocksLight, Action<int, int> setVisible, Func<int, int, int> getDistance)
    {
    ...
    public void Compute(IntVector origin, int rangeLimit)
    {
